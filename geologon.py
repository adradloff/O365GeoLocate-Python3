...
#   2.01 - Major revision to Python3 with some capabilities needing work
#
# Description:
...
# Converted to Python3 by Shae Bailey at Sentinel Technologies 2021
# Email: david.pany@fireeye.com
# Twitter: @davidpany
#
# Converted to Python3 by Shae Bailey at Sentinel Technologies - 2021
# Email sbailey@sentinel.com
#
# License:
#
...
try:
    ...
    sys.stderr.write("Please install the requests dependency:\n\tpip install requests\n")
    ...
    try:
        ...
        try:
            ...
            sys.stderr.write("\nCouldn't find the GeoIP DB. Attempting download now from "
                             ...
                             ".tar.gz\n")
            urlretrieve("http://geolite.maxmind.com/download/geoip/database/GeoLite2-City"
    ...
    try:
        ...
        try:
            ...
            sys.stderr.write("\nCouldn't find the ASN DB. Attempting download now from "
                             ...
                             ".tar.gz\n")
            urlretrieve("http://geolite.maxmind.com/download/geoip/database/GeoLite2-ASN"
...
def create_dch_dict():
    ...
    dch_file = str(dch_response.read().decode())
    dch_dict = {}
...
def get_csv_details(line):
    ...
    line_list = line.split(",")
    try:
        time = datetime.strptime(line_list[0], '%m/%d/%Y %H:%M')  # ex. 2017-05-15 13:56
    except ValueError:
        time = datetime.strptime(line_list[0], '%m/%d/%Y %I:%M:%S %p')  # ex. 2017-05-15 13:56:23
    finally:
        pass
    ...
    print(ip_string)
    #print(f"Analyzing the following IPs {ip_string}")  # prints IP list to stdout
...
def calculate_logon_differences(user_list):
    ...
    print(difference_dict["location_miles_diff"])  # Prints mile difference to stdout
    ...
    print(difference_dict["first_subdivision"], "1st")  # Prints 1st info to stdout .decode if encode added
    ...
    print(difference_dict["second_subdivision"], "2nd")  # Prints 2nd info to stdout .decode if encode added
...
def main(args):
    ...
    # Determine which type of log we have based on argument
    if args.csv:
        input_path = args.csv
    elif args.ip_only:
...
if __name__ == "__main__":
    ...
    sys.stderr.write("\n   Thank you for using GeoLogonAnalyzer.py, created by David Pany at"
                     " FireEye, Inc.\n      Version 1.01\n")
    sys.stderr.write("\n   Converted to Python3 by Shae Bailey at Sentinel Technologies"
                     "\n      Version 2.01\n\n")
